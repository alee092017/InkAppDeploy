...
class PensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pen" do
    assert_difference('Pen.count') do
      post pens_url, params: { pen: { description: @pen.description, image_url: @pen.image_url, ink_color: @pen.ink_color, model_no: @pen.model_no, name: @pen.name, tip_size: @pen.tip_size } }
    end
  ...
  test "should update pen" do
    patch pen_url(@pen), params: { pen: { description: @pen.description, image_url: @pen.image_url, ink_color: @pen.ink_color, model_no: @pen.model_no, name: @pen.name, tip_size: @pen.tip_size } }
